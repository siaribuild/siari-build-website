...
// Query: *[_type == "siteSettings"][0] {  siteName,  tagline,  phone,  email,  address,  copyrightText,  legalLine,  workingHours,  "businessPhoto": businessPhoto.asset->url,  "logo": logo.asset->url,  maintenanceEnabled,  maintenanceHeading,  maintenanceMessage,  maintenanceShowContact,  "maintenanceImage": maintenanceImage.asset->url,  notFoundHeading,  notFoundMessage,  notFoundButtonLabel,  "notFoundImage": notFoundImage.asset->url,  mapLocation,  mapZoom,  mapAddressLabel,  mapHidePin,  mapAreaRadius}
...
// Query: *[_type == "navigation"][0] {  headerMenu[] {    "pageSlug": page->slug.current,    "pageTitle": page->title,    label  },  headerCtaEnabled,  footerMenu[] {    "pageSlug": page->slug.current,    "pageTitle": page->title,    label  },  socialMenu[] {    label,    url,    "icon": icon.asset->url,    hideFromMenu  }}
...
// Query: *[_type == "page" && slug.current == "home"][0]  .sections[_type == "heroHome" || _type == "heroInner"][0].backgroundImage.asset->url
export type HOME_HERO_QUERY_RESULT = string | null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '*[_type == "page" && slug.current == "home"][0]\n  .sections[_type == "heroHome" || _type == "heroInner"][0].backgroundImage.asset->url': HOME_HERO_QUERY_RESULT;
