...
export function PageBuilder({ sections, blockData }: Props) {
      ...
      {sections.map((section, i) => {
        ...
        switch (section._type) {
          ...
          case 'featuredProjects':
            return (
              <FeaturedProjects
                ...
                ctaLabel={s.ctaLabel}
                ctaLink={s.ctaLink}
                projects={blockData?.featuredProjects ?? undefined}
              />
            )

          case 'projectsGrid':
            return <ProjectsGrid key={key} theme={s.theme} joinTop={joinTop} joinBottom={joinBottom} projects={blockData?.projects ?? undefined} categories={blockData?.categories ?? undefined} />
          ...
          case 'contactFormBlock':
            return <ContactFormBlock key={key} theme={s.theme} formHeading={s.formHeading} infoHeading={s.infoHeading} joinTop={joinTop} joinBottom={joinBottom} categories={blockData?.allCategories ?? undefined} />
